...
52 reversing challenges from past CTFs that `ppy-rev solve` answers, most of them
...
| [angstrom_high_quality_checks](angstrom_high_quality_checks/README.md) | ångstromCTF 2019 | stdin | none | `actf{fun_func710n5}` | 4 s |
...
| [litctf_addition](litctf_addition/README.md) | LIT CTF 2022 | stdin | none | `LITCTF{add1ti0n_is_h4rd}` | 4 s |
...
| [ricerca_crackme](ricerca_crackme/README.md) | Ricerca CTF 2023 | stdin | none | `N1pp0n-Ich!_s3cuR3_p45$w0rD` | 4 s |
...
| [uiuctf_tedious](uiuctf_tedious/README.md) | UIUCTF 2021 | stdin | none | `uiuctf{y0u_f0unD_t43_fl4g_w0w_gud_j0b}` | 7 s |
...
| [l3akctf_angry](l3akctf_angry/README.md) | L3akCTF 2024 | stdin | `--flag-format 'L3AK{*}'` | `L3AK{angr_4_l@f3_d0nt_do_i@_m4nU4lly}` | 11 s |
| [litctf_sequence_lock](litctf_sequence_lock/README.md) | LIT CTF 2026 | stdin | none | `LITCTF{f1bon4cci_ch41ns_ftw}` | 12 s |
| [sunshinectf_baseic](sunshinectf_baseic/README.md) | SunshineCTF 2025 | stdin | none | `sun{c0v3r1ng_ur_B4535}` | 13 s |
...
| [foobarctf_cipher_maze](foobarctf_cipher_maze/README.md) | FooBarCTF 2025 | stdin | none | `x0r_and_l0g1c@l_sh1ft_e@sy_r1gh8??` | 51 s |
| [csaw_beleaf](csaw_beleaf/README.md) | CSAW CTF Qualification Round 2019 | stdin | `--length 33` | `flag{we_beleaf_in_your_re_future}` | 164 s |
