...
| [hackappatoi_sanity_rev](hackappatoi_sanity_rev/README.md) | Hackappatoi CTF 2022 | argv[1] | none | `hctf{It_h4s_b33N_345Y}` | 1 s |
| [hsctf_keygen](hsctf_keygen/README.md) | HSCTF 2023 | argv[1] | none | `flag{6275745f-7768-6174-5f6c-6f636b3f0000}` | 1 s |
| [l3akctf_hidden](l3akctf_hidden/README.md) | L3akCTF 2024 | argv[1] | none | `L3AK{b4by_sT3Ps}` | 1 s |
...
| [heroctf_scarface](heroctf_scarface/README.md) | HeroCTF 2023 | stdin | none | `S4y_H3lL0_t0_mY_l1ttl3_FR13ND!!` | 3 s |
| [imaginaryctf_keycode](imaginaryctf_keycode/README.md) | ImaginaryCTF 2021 | stdin | none | `ictf{wh@t_g00d_i5_@_10ck_!f_th3_l0ck_!s_th3_k3y?}` | 3 s |
...
| [tamuctf_nope](tamuctf_nope/README.md) | TAMUctf 2023 | argv[1] | none | `gigem{fUnky_1nlin3_4sm}` | 3 s |
...
| [defcamp_r100](defcamp_r100/README.md) | DefCamp CTF Qualification 2015 | stdin | none | `Code_Talkers` | 4 s |
| [lactf_string_cheese](lactf_string_cheese/README.md) | LA CTF 2023 | stdin | none | `blueberry` | 4 s |
| [metactf_revvy_chevy](metactf_revvy_chevy/README.md) | MetaCTF 2021 | stdin | none | `MetaCTF{pr0p3r_encrypt10n_1snt_s0_e4sy...}` | 4 s |
| [picoctf_bbbbloat](picoctf_bbbbloat/README.md) | picoCTF 2022 | stdin | `--goal-address 0x1014d6` | `549255` | 4 s |
| [digitaloverdose_vault](digitaloverdose_vault/README.md) | Digital Overdose CTF 2022 | stdin | none | `DOCTF{H4CK3RPR00F}` | 5 s |
| [ijctf_sanity](ijctf_sanity/README.md) | IJCTF 2021 | stdin | none | `IJCTF{you_did_not_fall_for_it_right?}` | 5 s |
...
| [redpwn_check](redpwn_check/README.md) | redpwn CTF 2022 | stdin | none | `hope{oops_all_flag_checkers_64961defe21b15e8}` | 5 s |
...
| [l3akctf_angry](l3akctf_angry/README.md) | L3akCTF 2024 | stdin | `--flag-format 'L3AK{*}'` | `L3AK{angr_4_l@f3_d0nt_do_i@_m4nU4lly}` | 12 s |
| [litctf_sequence_lock](litctf_sequence_lock/README.md) | LIT CTF 2026 | stdin | none | `LITCTF{f1bon4cci_ch41ns_ftw}` | 13 s |
| [sunshinectf_baseic](sunshinectf_baseic/README.md) | SunshineCTF 2025 | stdin | none | `sun{c0v3r1ng_ur_B4535}` | 15 s |
| [foobarctf_babyrev](foobarctf_babyrev/README.md) | FooBarCTF 2022 | argv[1] | none | `GLUG{C01nc1d3nc3_c4n_b3_fr3aky_T6LSERDYB6}` | 16 s |
| [thjcc_pocketvm](thjcc_pocketvm/README.md) | THJCC 2026 | stdin | none | `THJCC{71ny_vm_5h311_p4ck}` | 17 s |
| [tscctf_link_start](tscctf_link_start/README.md) | TSCCTF 2025 | stdin | none | `TSC{Y0u_4Re_a_L1nK3d_LI5t_MasTeR_@ka_LLM~~~}` | 18 s |
...
| [crewctf_ez_rev](crewctf_ez_rev/README.md) | CrewCTF 2023 | stdin | none | `flag{ez_rev_goes_brrrrr....but_wait_a_seccond_the_format_flag_looks_weird}` | 48 s |
| [foobarctf_cipher_maze](foobarctf_cipher_maze/README.md) | FooBarCTF 2025 | stdin | none | `x0r_and_l0g1c@l_sh1ft_e@sy_r1gh8??` | 49 s |
