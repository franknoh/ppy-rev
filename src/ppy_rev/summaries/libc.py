...
FUNCTIONS: dict[str, LibraryFunction] = {
    ...
    for function in (
        ...
        LibraryFunction("getenv", 1),
        LibraryFunction("access", 2),
        LibraryFunction("close", 1),
        ...
        LibraryFunction("std::ifstream::ifstream", 2),
        LibraryFunction("std::ifstream::is_open", 1),
        LibraryFunction("std::ifstream::close", 1),
        LibraryFunction("std::ios::fail", 1),
        LibraryFunction("std::ios::good", 1),
        LibraryFunction("std::ios::eof", 1),
